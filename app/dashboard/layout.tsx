...
import HeaderAlert from '@/app/components/headerAlert'
    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex">
          ...
          {/* Conteúdo principal */}
          <main className={`flex-1 w-full min-h-screen transition-all duration-200 ease-in-out ${sidebarOpen ? 'lg:pl-64' : ''
            }`}>
            <div className="p-4">
      <HeaderAlert />
